...
print("reading in wt system")
wt_system = bss.IO.readMolecules([f"{input_directory}/unbound/state_A/solv_ions.gro",
                                   f"{input_directory}/unbound/state_A/topol.top"])

print("reading in mut system")
mut_system = bss.IO.readMolecules([f"{input_directory}/unbound/state_B/solv_ions.gro",
                                    f"{input_directory}/unbound/state_B/topol.top"])
...
print("setting up unbound states")

bss.FreeEnergy.Relative(
    system=merged_system,
    protocol=min_protocol,
    engine="GROMACS",
    work_dir=outputs + "/unbound/min/",
    setup_only=True,
